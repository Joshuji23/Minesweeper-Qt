...
template <> constexpr inline auto MineWindow::qt_create_metaobjectdata<qt_meta_tag_ZN10MineWindowE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'onSecondaryLevel'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onAdvancedLevel'
        ...
        QtMocHelpers::SlotData<void(MineField::GameState)>(13, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 14, 15 },
        }}),
        // Slot 'onRemainingMinesChanged'
...
void MineWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onPrimaryLevel(); break;
        case 2: _t->onSecondaryLevel(); break;
        case 3: _t->onAdvancedLevel(); break;
        case 4: _t->onCustomLevel(); break;
        case 5: _t->onTimerTick(); break;
        case 6: _t->onCellLeftClicked(); break;
        case 7: _t->onCellRightClicked(); break;
        case 8: _t->onCellUpdated((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[2]))); break;
        case 9: _t->onGameStateChanged((*reinterpret_cast<std::add_pointer_t<MineField::GameState>>(_a[1]))); break;
        case 10: _t->onRemainingMinesChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
}
